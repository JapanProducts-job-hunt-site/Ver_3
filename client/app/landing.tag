...
-->
	...
	<script type='es6'>
	this.submit = (e) => {
	console.log('Submit clicked ' + this.refs.firstName.value + ' ' + this.refs.lastName.value)
	...
	xhr.send(this.queryStringify(this.refs.firstName.value, this.refs.lastName.value, this.refs.password.value, this.refs.email.value));
	}
